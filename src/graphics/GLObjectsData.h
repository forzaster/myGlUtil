...
static Vertex sVertex1[] = {
    {{-1.0f, -1.0f, 0.0f}, {0x00, 0xFF, 0x00}, {0.0f, 0.0f}},
    {{ 1.0f, -1.0f, 0.0f}, {0x00, 0x00, 0xFF}, {1.0f, 0.0f}},
    {{-1.0f,  1.0f, 0.0f}, {0xFF, 0x00, 0x00}, {0.0f, 1.0f}},
    {{ 1.0f,  1.0f, 0.0f}, {0xFF, 0xFF, 0xFF}, {1.0f, 1.0f}},
};

static Vertex sVertex2[] = {
    {{-2.8f, -4.9f, 0.0f}, {0x00, 0xFF, 0x00}, {0.0f, 0.0f}},
    {{ 2.8f, -4.9f, 0.0f}, {0x00, 0x00, 0xFF}, {1.0f, 0.0f}},
    {{-2.8f,  4.9f, 0.0f}, {0xFF, 0x00, 0x00}, {0.0f, 1.0f}},
    {{ 2.8f,  4.9f, 0.0f}, {0xFF, 0xFF, 0xFF}, {1.0f, 1.0f}},
};
